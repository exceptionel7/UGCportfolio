...
const DEFAULT_DATA = {
  ...
  services: [
    { icon: "📦", title: "Product Demonstrations", desc: "Show products naturally and clearly so buyers instantly get the value." },
    { icon: "🎁", title: "Unboxing Videos", desc: "Exciting first-impression content that captures the reveal moment." },
    { icon: "💬", title: "Testimonials", desc: "Authentic creator-style reviews that build trust and social proof." },
    { icon: "🧩", title: "Problem → Solution", desc: "Frame the customer's problem, then demonstrate how the product solves it." },
    { icon: "🎙️", title: "Voiceover Videos", desc: "Professional product storytelling with clear, persuasive narration." },
    { icon: "⚡", title: "TikTok-Style Ads", desc: "Fast, engaging vertical advertisements built to stop the scroll." },
    { icon: "📸", title: "Product Photography", desc: "Clean lifestyle and product images for stores, ads and social." },
    { icon: "🤖", title: "AI-Assisted Concepts", desc: "AI-developed hooks, scripts, concepts and variations — kept authentic." },
  ],
